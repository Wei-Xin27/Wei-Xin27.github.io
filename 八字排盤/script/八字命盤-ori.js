...
function 尋起運(生日, 上個節氣, 下個節氣, 陽男陰女) {
    ...
    if ((陽男陰女 == "陽男") || (陽男陰女 == "陰女")) {
        ...
        //console.log("生日時辰:" + 生日時辰數 + ",節氣時辰數:"+節氣時辰數 + ",時差數:"+時差數);
        //console.log(時差數 + ", " + 天差數 + ", " + 距離節氣小時 + ", " + 生日 + ", " + 上個節氣);
    }
    ...
    if ((陽男陰女 == "陰男") || (陽男陰女 == "陽女")) {
        ...
        var 節氣時辰數=時間轉換地支(節氣時辰, "時數");
        時差數=((生日時辰數-節氣時辰數)<0)?生日時辰數-節氣時辰數+12:生日時辰數-節氣時辰數;
        //console.log("生日時辰:" + 生日時辰數 + ",節氣時辰數:"+節氣時辰數 + ",時差數:"+時差數);
        //console.log(時差數 + ", " + 天差數 + ", " + 距離節氣小時 + ", " + 生日 + ", " + 上個節氣);
        //console.log(moment.duration(生日-上個節氣).asHours());
    }
    ...
    //起年 = Math.floor(時差數 / (3 * 24));
    //起月 = Math.floor((時差數 % (3 * 24)) * 4 / 24);
