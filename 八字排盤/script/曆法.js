...
function 西曆轉換(輸入西曆日期) {
    ...
    **/
    ...
    var 輸入日期 = new Date(輸入西曆日期.getFullYear(), 輸入西曆日期.getMonth(), 輸入西曆日期.getDate(),0,0,0,0);
    var 輸入時間 = 輸入西曆日期.getHours() + ":" + 輸入西曆日期.getMinutes() + ":" + "00";
    ...
    if(運算的西曆 < 日期值轉換(曆法數據[YearData].小寒, 1)) {
        節氣 = "冬至";
		節氣數 = 21;
        節氣時段 = "冬至後，小寒前";
        節 = "大雪";
        節日期 = 日期值轉換(曆法數據[YearData-1].大雪, 1);
        //距離節的天數=DateDiff(節日期,運算的西曆,"days");
        距離節的天數 = momentDateDiff(運算的西曆, 節日期);

        //alert(節氣+": "+ 節日期 + " / " + "生日：" + 運算的西曆);
        下個節氣日期 = 日期值轉換(曆法數據[YearData].小寒, 1); //Enum日期轉換.日期與時間
        上個節氣日期 = 日期值轉換(曆法數據[YearData - 1].大雪, 1); //去年
        //下個節氣時差=DateDiff(運算的西曆, 下個節氣日期,"hours");
        //上個節氣時差=DateDiff(上個節氣日期,運算的西曆,"hours");
        //下個節氣時差 = momentDateDiff(下個節氣日期, 運算的西曆, "hours");
        //上個節氣時差 = momentDateDiff(運算的西曆, 上個節氣日期, "hours");
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].小寒, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].大寒, 1))) {
        節氣 = "小寒";
		節氣數 = 22;
        節氣時段 = "小寒後，大寒前";
        節 = "小寒";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].大寒, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].立春, 1))) {
        節氣 = "大寒";
		節氣數 = 23;
        節氣時段 = "大寒後，立春前";
        節 = "小寒";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].立春, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].雨水, 1))) {
        節氣 = "立春";
		節氣數 = 0;
        節氣時段 = "立春後，雨水前";
        節 = "立春";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].雨水, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].驚蟄, 1))) {
        節氣 = "雨水";
		節氣數 = 1;
        節氣時段 = "雨水後，驚蟄前";
        節 = "立春";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].驚蟄, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].春分, 1))) {
        節氣 = "驚蟄";
		節氣數 = 2;
        節氣時段 = "驚蟄後，春分前";
        節 = "驚蟄";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].春分, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].清明, 1))) {
        節氣 = "春分";
		節氣數 = 3;
        節氣時段 = "春分後，清明前";
        節 = "驚蟄";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].清明, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].穀雨, 1))) {
        節氣 = "清明";
		節氣數 = 4;
        節氣時段 = "清明後，穀雨前";
        節 = "清明";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].穀雨, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].立夏, 1))) {
        節氣 = "穀雨";
		節氣數 = 5;
        節氣時段 = "穀雨後，立夏前";
        節 = "清明";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].立夏, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].小滿, 1))) {
        節氣 = "立夏";
		節氣數 = 6;
        節氣時段 = "立夏後，小滿前";
        節 = "立夏";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].小滿, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].芒種, 1))) {
        節氣 = "小滿";
		節氣數 = 7;
        節氣時段 = "小滿後，芒種前";
        節 = "立夏";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].芒種, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].夏至, 1))) {
        節氣 = "芒種";
		節氣數 = 8;
        節氣時段 = "芒種後，夏至前";
        節 = "芒種";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].夏至, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].小暑, 1))) {
        節氣 = "夏至";
		節氣數 = 9;
        節氣時段 = "夏至後，小暑前";
        節 = "芒種";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].小暑, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].大暑, 1))) {
        節氣 = "小暑";
		節氣數 = 10;
        節氣時段 = "小暑後，大暑前";
        節 = "小暑";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].大暑, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].立秋, 1))) {
        節氣 = "大暑";
		節氣數 = 11;
        節氣時段 = "大暑後，立秋前";
        節 = "小暑";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].立秋, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].處暑, 1))) {
        節氣 = "立秋";
		節氣數 = 12;
        節氣時段 = "立秋後，處暑前";
        節 = "立秋";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].處暑, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].白露, 1))) {
        節氣 = "處暑";
		節氣數 = 13;
        節氣時段 = "處暑後，白露前";
        節 = "立秋";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].白露, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].秋分, 1))) {
        節氣 = "白露";
		節氣數 = 14;
        節氣時段 = "白露後，秋分前";
        節 = "白露";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].秋分, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].寒露, 1))) {
        節氣 = "秋分";
		節氣數 = 15;
        節氣時段 = "秋分後，寒露前";
        節 = "白露";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].寒露, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].霜降, 1))) {
        節氣 = "寒露";
		節氣數 = 16;
        節氣時段 = "寒露後，霜降前";
        節 = "寒露";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].霜降, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].立冬, 1))) {
        節氣 = "霜降";
		節氣數 = 17;
        節氣時段 = "霜降後，立冬前";
        節 = "寒露";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].立冬, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].小雪, 1))) {
        節氣 = "立冬";
		節氣數 = 18;
        節氣時段 = "立冬後，小雪前";
        節 = "立冬";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].小雪, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].大雪, 1))) {
        節氣 = "小雪";
		節氣數 = 19;
        節氣時段 = "小雪後，大雪前";
        節 = "立冬";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].大雪, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData].冬至, 1))) {
        節氣 = "大雪";
		節氣數 = 20;
        節氣時段 = "大雪後，冬至前";
        節 = "大雪";
    ...
    } else if ((運算的西曆>=日期值轉換(曆法數據[YearData].冬至, 1)) && (運算的西曆<日期值轉換(曆法數據[YearData+1].小寒, 1))) {
        節氣 = "冬至";
		節氣數 = 21;
        節氣時段 = "冬至後，小寒前";
        節 = "大雪";
    ...
    干支曆數據 = [干支曆, 干支年, 干支月, 干支日, 干支時, 生肖, 節氣, 交節日字串, 上個節氣日期, 下個節氣日期, 節, 節日期, 距離節的天數, 節氣數];
    var 干支曆={"日期": 干支曆, "年干支數": 干支年, "月干支數": 干支月, "日干支數": 干支日, "時干支數": 干支時, "生肖": 生肖, "節氣": 節氣, "節氣數": 節氣數, 
             "上個節氣日期": 上個節氣日期, "下個節氣日期": 下個節氣日期, "節": 節, "節日期": 節日期, "距離節的天數": 距離節的天數, "交節": 交節日字串};
    ...
    var 陰曆={"日期": 陰曆日期, "年": 陰曆年, "月": 陰曆月, "日": 陰曆日, "時支": 陰曆時支, "閏月": 陰曆閏月字, "干支年": 六十干支屬性(陰曆干支年,1)};
...
function 干支曆轉換(輸入干支日期) {
    ...
    **/
    ...
    for (var i = 0; 西曆年份 <= new Date().getFullYear()+3; i++) {
        ...
        console.log(節氣曆法數據);
        var 節氣干支曆 =  節氣曆法數據.干支曆.日期; //節氣曆法數據[0][0];
