...
// ******************** 神煞 **************************
function 尋神煞(年柱, 月柱, 日柱, 時柱, 性別, 陽男陰女) {
        ...
        地支=四柱地支.substr(i,1);
            switch(地支){
                case "子":
                    ...
                    if((四柱地支.indexOf("午")>=0) && (日干=="甲" || 日干=="乙") && (_.indexOf(已論斷神煞, "太極貴人")<0)) {
...
function 特殊神煞(年柱, 月柱, 日柱, 時柱, 陽男陰女) {
    ...
    */
    ...
    if ((日柱=="甲辰") || (日柱=="乙巳") || (日柱=="丙辰") || (日柱=="丁亥") || (日柱=="庚辰") || (日柱=="戊戌") || (日柱=="辛巳") || (日柱=="己丑") || (日柱=="壬申")  || (日柱=="癸亥")) 各柱神煞[2].push("十惡大敗");
    ...
    // 太極貴人, 垣城, 天廚, 天醫, 天德,月德,天醫
        switch(流運地支){
            ...
            case "丑":
                ...
                if(日支=="寅" || 日支=="卯" || 日支=="辰") 流運神煞.push("寡宿");
            ...
            case "寅":
                ...
                if(日支=="亥" || 日支=="子" || 日支=="丑") 流運神煞.push("孤辰"); //只判斷夫妻宮
            ...
            case "辰":
                ...
                if(日支=="巳" || 日支=="午" || 日支=="未") 流運神煞.push("寡宿");
            ...
            case "巳":
                ...
                if(日支=="寅" || 日支=="卯" || 日支=="辰") 流運神煞.push("孤辰");
            ...
            case "未":
                ...
                if(日支=="申" || 日支=="酉" || 日支=="戌") 流運神煞.push("寡宿");
            ...
            case "申":
                ...
                if(日支=="巳" || 日支=="午" || 日支=="未") 流運神煞.push("孤辰"); //只判斷夫妻宮
            ...
            case "戌":
                ...
                if(日支=="亥" || 日支=="子" || 日支=="丑") 流運神煞.push("寡宿");
            ...
            case "亥":
                ...
                if(日支=="申" || 日支=="酉" || 日支=="戌") 流運神煞.push("孤辰");
