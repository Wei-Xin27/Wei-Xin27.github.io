...
jQuery.fn.selectText = function(){
 ...
 function momentDateDiff(date1, date2, measurement) {
    ...
    return mdate1.diff(mdate2, measurement);
...
function QuickCheck(){
    ...
    var expDate = new Date(2050, 8, 26, 0, 0, 0, 0);
    
    if(curDate>expDate) expired=true;
    return expired;
}


// *************************************************
function IntegrityAudit(Version){
